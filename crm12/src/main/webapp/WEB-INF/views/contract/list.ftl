...
<head>
    ...
    <style type="text/css">
        .bodystyle{
            ...
            background:url("/images/carlos-muza-84523-unsplash.jpg") no-repeat;
...
<div class="container " style="margin-top: 20px">
    ...
    <div class="row">
        <div class="col-sm-3">
            <#assign currentMenu="contract_list"/>
            <#include "../common/menu.ftl">
        </div>
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-head-line">合同列表</h1>
                </div>
            </div>
            <!--高级查询--->
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <#--<a class="btn btn-info btn-xs btn-alipay" href="/getContract.do?id=${entity.id}">
                            <span class="glyphicon glyphicon-pencil"></span>支付
                        </a>-->
                        <a href="javascript:;" class="btn btn-danger btn-xs btn-delete" data-json="${entity.id}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">合同编辑</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="/contract/saveOrUpdate.do" method="post" id="transferForm"  style="margin: -3px 118px">
                    <input type="hidden" id="contract_id" value="" name="contract.id">
                    <input type="hidden" id="contract_seller_id" value="" name="contract.seller.id">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">客户姓名：</label>
                        <div class="col-sm-6">
                            <select id="customer_id" class="form-control" name="contract.customer.id" onchange="requestTel()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="phone" class="form-control" name="contract.customer.tel"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">销售人姓名：</label>
                        <div class="col-sm-6">
                            <input type="text" id="seller_name" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">销售人邮箱：</label>
                        <div class="col-sm-6">
                            <input type="text" id="seller_email" class="form-control" name="contract.seller.email"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">签约日期：</label>
                        <div class="col-lg-6 ">
                            <input type="text" class="form-control " id="contract_inputTime"  name="contract.inputTime" placeholder="请输入签约日期">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">签约金额：</label>
                        <div class="col-sm-6">
                            <input type="text" id="contract_money" class="form-control" name="contract.money" placeholder="请输入签约金额"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <textarea name="content.instruction" id="editor" rows="10" cols="85">
...
<script>
    ...
    function requestTel() {
        ...
        $.post("/customer/selectCustomerInfo.do",{tel:tel},function (data) {
           ...
           $("#phone").val(data.tel);
           $("#contract_seller_id").val(data.seller_id);
